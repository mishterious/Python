...
def index(request):
    return render(request,'bbready_app/index.html')
...
def register(request):
    ...
    if request.method == "POST":
        ...
        if form.errors:
            ...
            return render(
                request, "bbready_app/registration.html",
    ...
    return render(
        request, 'bbready_app/index.html', {"old_form": request.POST}
    )
...
def login(request):
    ...
    return render(
            request, "bbready_app/login_reg.html", {"old_form": request.POST}
        )
...
def success(request):
    if 'is_logged_in' not in request.session:
        ...
        return render(request, "bbready_app/success.html")
